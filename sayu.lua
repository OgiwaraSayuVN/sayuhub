...
function library:CreateWindow(text,maincolor,text2,logo)
    ...
    Hub.Position = UDim2.new(0, 125, 0, 0)
    Hub.Size = UDim2.new(0, 60, 0, 20)
    Hub.Font = Enum.Font.GothamSemibold
    Hub.Text = "Phiên Bản Thử Nghiểm"
    ...
    Logo.Image = "https://img.upanh.tv/2023/07/18/server-icon.pngbxassetid://"..tostring(logo)
    ...
    ImageButton.Image = "https://img.upanh.tv/2023/07/18/server-icon.png" -- LOGO
    ...
    function uitab:AddTab(text)
        ...
        function main:AddDropdown(text,option,callback)
			...
			DropImage.Image = "https://img.upanh.tv/2023/07/18/server-icon.png"
...
function InfAb()
    if InfAbility then
        if not game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
            ...
            inf.Color = ColorSequence.new(Color3.fromRGB(255,255,255),Color3.fromRGB(80,245,245))
...
--------------------------------------------------------------------
local RenUi = library:CreateWindow("Sayu",Color3.fromRGB(0,0,0),"")
-------------------------------------------------------------------
...
local IslandTP = RenUi:AddTab("TP BYPASS")
...
function UpdateTime()
    ...
    Time:Set("Giờ(s) : "..Hour.." Phút(s) : "..Minute.." Giây(s) : "..Second)
end
        ...
        if _G.FastAttack2 then
            if typeof(y) == "table" then
                pcall(function()
                    ...
                    y.activeController.hitboxMagnitude = 99
...
Main:AddToggle("Bring Mob",true,function(value)
    _G.BringMonsterZ = value
end)

    spawn(function()
        while task.wait() do
            pcall(function()
                if _G.BringMonsterZ then
                    CheckQuest()
...
SelectHealth = 25
_G.Kill_At = 25
Main:AddDropdown("Select Health",{"5","10","20","25","40","100"},function(value)
    SelectHealth = value
end)
...
Combat:AddSeperator("Quest Hunter")

	Combat:AddToggle("Auto Player Hunter",_G.AutoPlayerHunter,function(x)
	...
	spawn(function()
		while wait() do
			if _G.AutoPlayerHunter then
				if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
					repeat 
						totarget(CFrame.new(-5485.3505859375, 34.833587646484375, -3934.92529296875)) 
						wait() 
					...
					for i,v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
						if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,v.Name) then
							repeat wait()
								...
								EquipWeapon(_G.SelectWeapon)
								topos(v.HumanoidRootPart.CFrame * CFrame.new(1,10,1))	
                                                                wait(0)
								topos(v.HumanoidRootPart.CFrame * CFrame.new(5,40,-5))	
...
Dungeon:AddButton("Next Island",false,function()
    pcall(function()
        if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
        ...
        elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 2") then
            TP(wgame:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 2").CFrame*CFrame.new(0,70,100))
        elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1") then
...
Shop:AddToggle("Buy Surprise",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,1)
end)
...
Misc:AddButton("Remove Fog",RemoveFog,function(value)
